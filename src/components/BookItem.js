			...
			<div className="col-xs-6 col-md-4 col-lg-2">
				<div className="thumbnail">
					...
					<div className="caption">
						...
						{(borrowed) ? (
							<button className="btn btn-xs btn-default borrow-button" disabled>Đã mượn</button>
						) : (
							<button className="btn btn-xs btn-primary borrow-button" onClick={(e) => this.handleBorrow(e, book)}>Mượn sách</button>
						)}
					</div>
				</div>
			</div>
